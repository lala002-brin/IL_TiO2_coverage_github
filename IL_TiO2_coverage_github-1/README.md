...
Copy **bulk rutile TiO2 CIF** Anda ke folder `input` dan beri nama:

```text
input/TiO2.cif
```

Kemudian buat surface TiO2(110) 4-layer dan supercell 3×5:

```bash
python3 scripts/00_make_TiO2_110_3x5.py
```
...
## 0. Membuat surface rutile TiO2(110) 3×5

Workflow dimulai dari bulk rutile `TiO2.cif`.

```bash
python3 scripts/00_make_TiO2_110_3x5.py
```

ASE membangun surface dengan:
...
Untuk struktur bulk yang digunakan pada workflow awal, hasil yang diharapkan kira-kira:
